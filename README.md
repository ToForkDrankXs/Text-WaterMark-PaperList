...
- **[Enhancing LLM Watermark Resilience Against Both Scrubbing and Spoofing Attacks](https://arxiv.org/pdf/2507.06274)**
  - **Proceedings / Journal-Year**: 2025
  - **Key Word**: Logits-Bias
  - **Note**: Enhancing robustness and imperceptibility by control the window size and the numbers of hash mapping seeds.
  - **Code**: -

- **[BiMark: Unbiased Multilayer Watermarking for Large Language Models](https://arxiv.org/pdf/2506.21602)**
  - **Proceedings / Journal-Year**: ICML-2025
  - **Key Word**: Multi-Bit, Reweighting
  - **Note**: Multi-layer, and self adaptive strength
  - **Code**: <https://github.com/Kx-Feng/BiMark>

- **[Multi-use LLM Watermarking and the False Detection Problem](https://arxiv.org/pdf/2506.15975)**
  - **Proceedings / Journal-Year**: 2025
  - **Key Word**: Logits-Bias
  - **Note**: Multi secret key introduce the False Positives.
  - **Code**: -

- **[PVMark: Enabling Public Verifiability for LLM Watermarking Schemes](https://arxiv.org/pdf/2510.26274)**
  - **Proceedings / Journal-Year**: 2025
  - **Key Word**: Logits-Bias, and more
  - **Note**: Multi secret key introduce the False Positives.Modify the hash function to be ZKP-friendly, thereby enabling the watermark to be publicly verified using ZKP.
  - **Code**: -

- **[PRO: Enabling Precise and Robust Text Watermark for Open-Source LLMs](https://arxiv.org/pdf/2510.23891)**
  - **Proceedings / Journal-Year**: 2025
  - **Key Word**: Backdoor
  - **Note**: The backdoor source is a large-scale LLM with a watermark, aiming to publicly release the corresponding student LLM, making it watermarked and difficult to modify.
  - **Code**: -

- **[Task-Agnostic Language Model Watermarking via High Entropy Passthrough Layers](https://ojs.aaai.org/index.php/AAAI/article/view/34667)**
  - **Proceedings / Journal-Year**: AAAI2025
  - **Key Word**: Backdoor
  - **Note**: Train the direct pass-through layer and embed it directly into the model.
...
- **[A Survey of Text Watermarking in the Era of Large Language Models](https://arxiv.org/pdf/2312.07913)**
  - **Proceedings / Journal-Year**: ACM Survey-2025
  - **Type**: Survey
...
- **[Watermarking Large Language Models in Europe: Interpreting the AI Act in Light of Technology](https://arxiv.org/pdf/2511.03641)**
  - **Proceedings / Journal-Year**: 2025
  - **Type**: Survey
...
- **[Cross-Lingual Summarization as a Black-Box Watermark Removal Attack](https://arxiv.org/pdf/2510.24789)**
  - **Proceedings / Journal-Year**: 2025
  - **AttackType**: scrubbing
  - **Note**: Cross-Lingual retranslate to attack
  - **Code**: -
...
- **[Can LLM Watermarks Robustly Prevent Unauthorized Knowledge Distillation?](https://arxiv.org/abs/2502.11598)**
  ...
  - **AttackType**: spoofing
  - **Note**: Fine-Tune to learn watermark
...
- **[Red Teaming Language Model Detectors with Language Models](https://direct.mit.edu/tacl/article/doi/10.1162/tacl_a_00639/119629/Red-Teaming-Language-Model-Detectors-with-Language)**
  ...
  - **Detail**: About attack on different detection methods, including watermark
  - **Note**: -
...
- **[WaterSeeker: Efficient Detection of Watermarked Segments in Large Documents](https://arxiv.org/pdf/2409.05112)**
  - **Proceedings / Journal-Year**: 2024
  - **Detail**: About detection in only part of watermark text in a document
  - **Note**: -
...
- **[Inevitable Trade-off between Watermark Strength and Speculative Sampling Efficiency for Language Models](https://papers.nips.cc/paper_files/paper/2024/file/6415b5dc9aa4bf4e6404cb221a109ec7-Paper-Conference.pdf)**
  - **Proceedings / Journal-Year**: NeurIPS-2024
  - **Detail**: Trade-off between sample method efficiency and watermark
  - **Note**: -
  - **Code**: -

- **[Can Watermarked LLMs be Identified by Users via Crafted Prompts?](https://arxiv.org/pdf/2410.03168)**
  - **Proceedings / Journal-Year**: ICLR-2025
  - **Detail**: Vertiy LLM with watermark by prompts
  - **Note**: -
...
- **[Modification and Generated-Text Detection: Achieving Dual Detection Capabilities for the Outputs of LLM by Watermark](https://arxiv.org/pdf/2502.08332)**
  - **Proceedings / Journal-Year**: 2025
  - **Detail**: change detect method, add unexpected tokens to filter
  - **Note**: -
  - **Code**: -
...
- **[Sandcastles in the Storm: Revisiting the (Im)possibility of Strong Watermarking](https://aclanthology.org/2025.acl-long.1436.pdf)**
  - **Proceedings / Journal-Year**: ACL-2025
  - **Detail**: research about attack, good evaluation
  - **Note**: -
  - **Code**: -

- **[VLA-Mark: A cross modal watermark for large vision-language alignment model](https://arxiv.org/pdf/2507.14067)**
  - **Proceedings / Journal-Year**: EMNLP-2025
  - **Detail**: VLM watermark
  - **Note**: -
  - **Code**: -

- **[Advancing Machine-Generated Text Detection from an Easy to Hard Supervision Perspective](https://arxiv.org/pdf/2511.00988)**
  - **Proceedings / Journal-Year**: 2025
  - **Detail**: Detector
  - **Note**: A more fine-grained detection method, this idea may be applied to watermarks.
  - **Code**: <https://github.com/tmlr-group/Easy2Hard>
